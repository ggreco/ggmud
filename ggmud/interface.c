...
create_window_preferences (void)
{
  ...
  GtkWidget *hbox25;
  GtkWidget *checkbutton_msp;
  GtkWidget *button_msp;
  GtkWidget *label9;
  ...
  gtk_box_pack_start (GTK_BOX (hbox3), checkbutton_use_proxy, TRUE, TRUE, 0);
  ...
  gtk_box_pack_start (GTK_BOX (hbox3), button_socks_settings, FALSE, FALSE, 0);
  gtk_widget_set_sensitive (button_socks_settings, FALSE);
  ...
  gtk_box_pack_start (GTK_BOX (vbox9), hbox25, FALSE, FALSE, 0);

  checkbutton_msp = gtk_check_button_new_with_mnemonic ("MSP support");
  gtk_widget_show (checkbutton_msp);
  gtk_box_pack_start (GTK_BOX (hbox25), checkbutton_msp, TRUE, TRUE, 0);
  gtk_tooltips_set_tip (tooltips, checkbutton_msp, "Connect through a proxy.", NULL);

  button_msp = gtk_button_new_with_mnemonic ("Settings");
  gtk_widget_show (button_msp);
  gtk_box_pack_start (GTK_BOX (hbox25), button_msp, FALSE, FALSE, 0);
  gtk_widget_set_sensitive (button_msp, FALSE);
  gtk_tooltips_set_tip (tooltips, button_msp, "Edit socks proxy settings", NULL);
  gtk_button_set_relief (GTK_BUTTON (button_msp), GTK_RELIEF_HALF);
  ...
  g_signal_connect ((gpointer) button7, "clicked",
                    ...
                    NULL);
  g_signal_connect_swapped ((gpointer) checkbutton_use_proxy, "toggled",
                            G_CALLBACK (on_checkbutton_button_toggled),
                            GTK_OBJECT (button_socks_settings));
  g_signal_connect ((gpointer) button_socks_settings, "clicked",
                    G_CALLBACK (on_button_proxy_settings_clicked),
                    NULL);
  g_signal_connect_swapped ((gpointer) checkbutton_msp, "toggled",
                            G_CALLBACK (on_checkbutton_button_toggled),
                            GTK_OBJECT (button_msp));
  g_signal_connect ((gpointer) button_msp, "clicked",
                    G_CALLBACK (on_button_msp_clicked),
                    NULL);
  ...
  GLADE_HOOKUP_OBJECT (window_preferences, hbox25, "hbox25");
  GLADE_HOOKUP_OBJECT (window_preferences, checkbutton_msp, "checkbutton_msp");
  GLADE_HOOKUP_OBJECT (window_preferences, button_msp, "button_msp");
...
create_window_mccp_status (void)
{
  ...
  GtkWidget *vbox29;
  GtkWidget *hbox23;
  GtkWidget *image_msp_status;
  GtkWidget *label_msp_status;
  GtkWidget *hbox24;
  GtkWidget *frame22;
  GtkWidget *label_sounds;
  GtkWidget *label76;
  GtkWidget *frame23;
  GtkWidget *label_musics;
  GtkWidget *label78;
  GtkWidget *label74;
  ...
  gtk_window_set_title (GTK_WINDOW (window_mccp_status), "MCCP/MSP status");
  ...
  gtk_box_pack_start (GTK_BOX (vbox12), frame20, TRUE, TRUE, 0);
  gtk_frame_set_shadow_type (GTK_FRAME (frame20), GTK_SHADOW_IN);

  alignment6 = gtk_alignment_new (0.5, 0.5, 1, 1);
  gtk_widget_show (alignment6);
  gtk_container_add (GTK_CONTAINER (frame20), alignment6);
  gtk_alignment_set_padding (GTK_ALIGNMENT (alignment6), 0, 0, 8, 8);
  ...
  label73 = gtk_label_new ("<b>MCCP</b> - Mud Client Compression Protocol");
  gtk_widget_show (label73);
  gtk_frame_set_label_widget (GTK_FRAME (frame20), label73);
  gtk_label_set_use_markup (GTK_LABEL (label73), TRUE);
  gtk_misc_set_padding (GTK_MISC (label73), 4, 0);

  frame21 = gtk_frame_new (NULL);
  gtk_widget_show (frame21);
  gtk_box_pack_start (GTK_BOX (vbox12), frame21, TRUE, TRUE, 0);
  gtk_frame_set_shadow_type (GTK_FRAME (frame21), GTK_SHADOW_IN);

  alignment7 = gtk_alignment_new (0.5, 0.5, 1, 1);
  gtk_widget_show (alignment7);
  gtk_container_add (GTK_CONTAINER (frame21), alignment7);
  gtk_alignment_set_padding (GTK_ALIGNMENT (alignment7), 0, 0, 8, 8);

  vbox29 = gtk_vbox_new (FALSE, 0);
  gtk_widget_show (vbox29);
  gtk_container_add (GTK_CONTAINER (alignment7), vbox29);

  hbox23 = gtk_hbox_new (FALSE, 0);
  gtk_widget_show (hbox23);
  gtk_box_pack_start (GTK_BOX (vbox29), hbox23, TRUE, TRUE, 0);

  image_msp_status = create_pixmap (window_mccp_status, NULL);
  gtk_widget_show (image_msp_status);
  gtk_box_pack_start (GTK_BOX (hbox23), image_msp_status, FALSE, FALSE, 0);
  gtk_misc_set_padding (GTK_MISC (image_msp_status), 4, 4);

  label_msp_status = gtk_label_new ("<b>todo</b>");
  gtk_widget_show (label_msp_status);
  gtk_box_pack_start (GTK_BOX (hbox23), label_msp_status, FALSE, FALSE, 0);
  gtk_label_set_use_markup (GTK_LABEL (label_msp_status), TRUE);
  gtk_misc_set_padding (GTK_MISC (label_msp_status), 8, 8);

  hbox24 = gtk_hbox_new (FALSE, 0);
  gtk_widget_show (hbox24);
  gtk_box_pack_start (GTK_BOX (vbox29), hbox24, TRUE, TRUE, 0);

  frame22 = gtk_frame_new (NULL);
  gtk_widget_show (frame22);
  gtk_box_pack_start (GTK_BOX (hbox24), frame22, TRUE, TRUE, 0);
  gtk_container_set_border_width (GTK_CONTAINER (frame22), 8);

  label_sounds = gtk_label_new (".");
  gtk_widget_show (label_sounds);
  gtk_container_add (GTK_CONTAINER (frame22), label_sounds);
  gtk_label_set_use_markup (GTK_LABEL (label_sounds), TRUE);
  gtk_misc_set_padding (GTK_MISC (label_sounds), 8, 8);

  label76 = gtk_label_new ("<b>Sounds played</b>");
  gtk_widget_show (label76);
  gtk_frame_set_label_widget (GTK_FRAME (frame22), label76);
  gtk_label_set_use_markup (GTK_LABEL (label76), TRUE);

  frame23 = gtk_frame_new (NULL);
  gtk_widget_show (frame23);
  gtk_box_pack_start (GTK_BOX (hbox24), frame23, TRUE, TRUE, 0);
  gtk_container_set_border_width (GTK_CONTAINER (frame23), 8);

  label_musics = gtk_label_new (".");
  gtk_widget_show (label_musics);
  gtk_container_add (GTK_CONTAINER (frame23), label_musics);
  gtk_label_set_use_markup (GTK_LABEL (label_musics), TRUE);
  gtk_misc_set_padding (GTK_MISC (label_musics), 8, 8);

  label78 = gtk_label_new ("<b>Musics played</b>");
  gtk_widget_show (label78);
  gtk_frame_set_label_widget (GTK_FRAME (frame23), label78);
  gtk_label_set_use_markup (GTK_LABEL (label78), TRUE);

  label74 = gtk_label_new ("<b>MSP</b> - Mud Sound Protocol");
  gtk_widget_show (label74);
  gtk_frame_set_label_widget (GTK_FRAME (frame21), label74);
  gtk_label_set_use_markup (GTK_LABEL (label74), TRUE);
  gtk_misc_set_alignment (GTK_MISC (label74), 0.47, 0.5);
  gtk_misc_set_padding (GTK_MISC (label74), 4, 0);
  ...
  GLADE_HOOKUP_OBJECT (window_mccp_status, frame20, "frame20");
  GLADE_HOOKUP_OBJECT (window_mccp_status, alignment6, "alignment6");
  ...
  GLADE_HOOKUP_OBJECT (window_mccp_status, label73, "label73");
  GLADE_HOOKUP_OBJECT (window_mccp_status, frame21, "frame21");
  GLADE_HOOKUP_OBJECT (window_mccp_status, alignment7, "alignment7");
  GLADE_HOOKUP_OBJECT (window_mccp_status, vbox29, "vbox29");
  GLADE_HOOKUP_OBJECT (window_mccp_status, hbox23, "hbox23");
  GLADE_HOOKUP_OBJECT (window_mccp_status, image_msp_status, "image_msp_status");
  GLADE_HOOKUP_OBJECT (window_mccp_status, label_msp_status, "label_msp_status");
  GLADE_HOOKUP_OBJECT (window_mccp_status, hbox24, "hbox24");
  GLADE_HOOKUP_OBJECT (window_mccp_status, frame22, "frame22");
  GLADE_HOOKUP_OBJECT (window_mccp_status, label_sounds, "label_sounds");
  GLADE_HOOKUP_OBJECT (window_mccp_status, label76, "label76");
  GLADE_HOOKUP_OBJECT (window_mccp_status, frame23, "frame23");
  GLADE_HOOKUP_OBJECT (window_mccp_status, label_musics, "label_musics");
  GLADE_HOOKUP_OBJECT (window_mccp_status, label78, "label78");
  GLADE_HOOKUP_OBJECT (window_mccp_status, label74, "label74");
...
create_window_main (void)
{
  ...
  gtk_widget_set_size_request (window_main, 800, 600);
  ...
  image161 = gtk_image_new_from_stock ("gtk-dialog-info", GTK_ICON_SIZE_MENU);
  gtk_widget_show (image161);
  gtk_image_menu_item_set_image (GTK_IMAGE_MENU_ITEM (menuitem_conwiz), image161);
  ...
  menuitem_load_tt_prefs = gtk_image_menu_item_new_with_mnemonic ("Load TT++/GGMUD file...");
  gtk_widget_show (menuitem_load_tt_prefs);
  gtk_container_add (GTK_CONTAINER (menuitem2_menu), menuitem_load_tt_prefs);

  image162 = gtk_image_new_from_stock ("gtk-open", GTK_ICON_SIZE_MENU);
  gtk_widget_show (image162);
  gtk_image_menu_item_set_image (GTK_IMAGE_MENU_ITEM (menuitem_load_tt_prefs), image162);

  menuitem_import_zmud = gtk_image_menu_item_new_with_mnemonic ("Import ZMud config...");
  gtk_widget_show (menuitem_import_zmud);
  gtk_container_add (GTK_CONTAINER (menuitem2_menu), menuitem_import_zmud);

  image163 = gtk_image_new_from_stock ("gtk-go-back", GTK_ICON_SIZE_MENU);
  gtk_widget_show (image163);
  gtk_image_menu_item_set_image (GTK_IMAGE_MENU_ITEM (menuitem_import_zmud), image163);
  ...
  menuitem_save_positions = gtk_image_menu_item_new_with_mnemonic ("Save window positions");
  gtk_widget_show (menuitem_save_positions);
  gtk_container_add (GTK_CONTAINER (menuitem2_menu), menuitem_save_positions);

  image164 = gtk_image_new_from_stock ("gtk-save", GTK_ICON_SIZE_MENU);
  gtk_widget_show (image164);
  gtk_image_menu_item_set_image (GTK_IMAGE_MENU_ITEM (menuitem_save_positions), image164);

  menuitem_export_settings = gtk_image_menu_item_new_with_mnemonic ("Export settings");
  gtk_widget_show (menuitem_export_settings);
  gtk_container_add (GTK_CONTAINER (menuitem2_menu), menuitem_export_settings);

  image165 = gtk_image_new_from_stock ("gtk-go-forward", GTK_ICON_SIZE_MENU);
  gtk_widget_show (image165);
  gtk_image_menu_item_set_image (GTK_IMAGE_MENU_ITEM (menuitem_export_settings), image165);
  ...
  clear_review_buffer = gtk_image_menu_item_new_with_mnemonic ("Clear review");
  gtk_widget_show (clear_review_buffer);
  gtk_container_add (GTK_CONTAINER (menuitem2_menu), clear_review_buffer);

  image166 = gtk_image_new_from_stock ("gtk-clear", GTK_ICON_SIZE_MENU);
  gtk_widget_show (image166);
  gtk_image_menu_item_set_image (GTK_IMAGE_MENU_ITEM (clear_review_buffer), image166);
  ...
  image167 = gtk_image_new_from_stock ("gtk-save-as", GTK_ICON_SIZE_MENU);
  gtk_widget_show (image167);
  gtk_image_menu_item_set_image (GTK_IMAGE_MENU_ITEM (menuitem_save_review_buffer), image167);
  ...
  macros1 = gtk_image_menu_item_new_with_mnemonic ("Macros");
  gtk_widget_show (macros1);
  gtk_container_add (GTK_CONTAINER (tools1_menu), macros1);
  gtk_widget_add_accelerator (macros1, "activate", accel_group,
                              GDK_m, (GdkModifierType) GDK_MOD1_MASK,
                              GTK_ACCEL_VISIBLE);

  image168 = create_pixmap (window_main, "macro.xpm");
  gtk_widget_show (image168);
  gtk_image_menu_item_set_image (GTK_IMAGE_MENU_ITEM (macros1), image168);

  aliases1 = gtk_image_menu_item_new_with_mnemonic ("Aliases");
  ...
  image169 = create_pixmap (window_main, "alias.xpm");
  gtk_widget_show (image169);
  gtk_image_menu_item_set_image (GTK_IMAGE_MENU_ITEM (aliases1), image169);

  triggers1 = gtk_image_menu_item_new_with_mnemonic ("Triggers");
  ...
  image170 = create_pixmap (window_main, "trig.xpm");
  gtk_widget_show (image170);
  gtk_image_menu_item_set_image (GTK_IMAGE_MENU_ITEM (triggers1), image170);

  highlights1 = gtk_image_menu_item_new_with_mnemonic ("Highlights");
  gtk_widget_show (highlights1);
  gtk_container_add (GTK_CONTAINER (tools1_menu), highlights1);

  image171 = gtk_image_new_from_stock ("gtk-underline", GTK_ICON_SIZE_MENU);
  gtk_widget_show (image171);
  gtk_image_menu_item_set_image (GTK_IMAGE_MENU_ITEM (highlights1), image171);

  gags1 = gtk_image_menu_item_new_with_mnemonic ("Gags");
  gtk_widget_show (gags1);
  gtk_container_add (GTK_CONTAINER (tools1_menu), gags1);
  gtk_widget_add_accelerator (gags1, "activate", accel_group,
                              GDK_g, (GdkModifierType) GDK_MOD1_MASK,
                              GTK_ACCEL_VISIBLE);

  image172 = gtk_image_new_from_stock ("gtk-strikethrough", GTK_ICON_SIZE_MENU);
  gtk_widget_show (image172);
  gtk_image_menu_item_set_image (GTK_IMAGE_MENU_ITEM (gags1), image172);

  substitutions1 = gtk_image_menu_item_new_with_mnemonic ("Substitutions");
  gtk_widget_show (substitutions1);
  gtk_container_add (GTK_CONTAINER (tools1_menu), substitutions1);

  image173 = gtk_image_new_from_stock ("gtk-find-and-replace", GTK_ICON_SIZE_MENU);
  gtk_widget_show (image173);
  gtk_image_menu_item_set_image (GTK_IMAGE_MENU_ITEM (substitutions1), image173);
  ...
  buttons = gtk_image_menu_item_new_with_mnemonic ("Buttons");
  gtk_widget_show (buttons);
  gtk_container_add (GTK_CONTAINER (tools1_menu), buttons);

  image174 = gtk_image_new_from_stock ("gtk-media-stop", GTK_ICON_SIZE_MENU);
  gtk_widget_show (image174);
  gtk_image_menu_item_set_image (GTK_IMAGE_MENU_ITEM (buttons), image174);
  ...
  gtk_widget_add_accelerator (log_viewer1, "activate", accel_group,
                              GDK_l, (GdkModifierType) GDK_SHIFT_MASK | GDK_MOD1_MASK,
                              GTK_ACCEL_VISIBLE);

  image175 = gtk_image_new_from_stock ("gtk-justify-left", GTK_ICON_SIZE_MENU);
  gtk_widget_show (image175);
  gtk_image_menu_item_set_image (GTK_IMAGE_MENU_ITEM (log_viewer1), image175);
  ...
  trigger_classes = gtk_image_menu_item_new_with_mnemonic ("Enable/disable trigger classes");
  gtk_widget_show (trigger_classes);
  gtk_container_add (GTK_CONTAINER (tools1_menu), trigger_classes);

  image176 = create_pixmap (window_main, "trig.xpm");
  gtk_widget_show (image176);
  gtk_image_menu_item_set_image (GTK_IMAGE_MENU_ITEM (trigger_classes), image176);

  menuitem_mccp_status = gtk_image_menu_item_new_with_mnemonic ("MCCP/MSP status");
  gtk_widget_show (menuitem_mccp_status);
  gtk_container_add (GTK_CONTAINER (tools1_menu), menuitem_mccp_status);

  image177 = gtk_image_new_from_stock ("gtk-dialog-question", GTK_ICON_SIZE_MENU);
  gtk_widget_show (image177);
  gtk_image_menu_item_set_image (GTK_IMAGE_MENU_ITEM (menuitem_mccp_status), image177);
  ...
  gtk_tooltips_set_tip (tooltips, help1, "Show GGMud help", NULL);

  image178 = gtk_image_new_from_stock ("gtk-help", GTK_ICON_SIZE_MENU);
  gtk_widget_show (image178);
  gtk_image_menu_item_set_image (GTK_IMAGE_MENU_ITEM (help1), image178);
  ...
  gtk_image_menu_item_set_image (GTK_IMAGE_MENU_ITEM (documentation), image179);
  ...
  image180 = gtk_image_new_from_stock ("gtk-home", GTK_ICON_SIZE_MENU);
  gtk_widget_show (image180);
  gtk_image_menu_item_set_image (GTK_IMAGE_MENU_ITEM (homepage), image180);
  ...
  g_signal_connect ((gpointer) menuitem_export_settings, "activate",
                    ...
                    NULL);
  g_signal_connect ((gpointer) clear_review_buffer, "activate",
                    G_CALLBACK (on_clear_review_buffer_activate),
                    NULL);
  ...
  g_signal_connect ((gpointer) gags1, "activate",
                    ...
                    NULL);
  g_signal_connect ((gpointer) substitutions1, "activate",
                    G_CALLBACK (window_subs),
                    NULL);
  ...
  g_signal_connect ((gpointer) variables1, "activate",
                    ...
                    NULL);
  g_signal_connect ((gpointer) buttons, "activate",
                    G_CALLBACK (on_buttons_activate),
                    NULL);
  ...
  GLADE_HOOKUP_OBJECT (window_main, image161, "image161");
  ...
  GLADE_HOOKUP_OBJECT (window_main, image162, "image162");
  GLADE_HOOKUP_OBJECT (window_main, menuitem_import_zmud, "menuitem_import_zmud");
  GLADE_HOOKUP_OBJECT (window_main, image163, "image163");
  ...
  GLADE_HOOKUP_OBJECT (window_main, image164, "image164");
  GLADE_HOOKUP_OBJECT (window_main, menuitem_export_settings, "menuitem_export_settings");
  GLADE_HOOKUP_OBJECT (window_main, image165, "image165");
  GLADE_HOOKUP_OBJECT (window_main, separator6, "separator6");
  GLADE_HOOKUP_OBJECT (window_main, clear_review_buffer, "clear_review_buffer");
  GLADE_HOOKUP_OBJECT (window_main, image166, "image166");
  GLADE_HOOKUP_OBJECT (window_main, menuitem_save_review_buffer, "menuitem_save_review_buffer");
  GLADE_HOOKUP_OBJECT (window_main, image167, "image167");
  ...
  GLADE_HOOKUP_OBJECT (window_main, image168, "image168");
  GLADE_HOOKUP_OBJECT (window_main, aliases1, "aliases1");
  GLADE_HOOKUP_OBJECT (window_main, image169, "image169");
  GLADE_HOOKUP_OBJECT (window_main, triggers1, "triggers1");
  GLADE_HOOKUP_OBJECT (window_main, image170, "image170");
  GLADE_HOOKUP_OBJECT (window_main, highlights1, "highlights1");
  GLADE_HOOKUP_OBJECT (window_main, image171, "image171");
  GLADE_HOOKUP_OBJECT (window_main, gags1, "gags1");
  GLADE_HOOKUP_OBJECT (window_main, image172, "image172");
  GLADE_HOOKUP_OBJECT (window_main, substitutions1, "substitutions1");
  GLADE_HOOKUP_OBJECT (window_main, image173, "image173");
  GLADE_HOOKUP_OBJECT (window_main, tab_complete1, "tab_complete1");
  GLADE_HOOKUP_OBJECT (window_main, variables1, "variables1");
  GLADE_HOOKUP_OBJECT (window_main, buttons, "buttons");
  GLADE_HOOKUP_OBJECT (window_main, image174, "image174");
  ...
  GLADE_HOOKUP_OBJECT (window_main, image178, "image178");
  GLADE_HOOKUP_OBJECT (window_main, documentation, "documentation");
  GLADE_HOOKUP_OBJECT (window_main, image179, "image179");
  GLADE_HOOKUP_OBJECT (window_main, homepage, "homepage");
  GLADE_HOOKUP_OBJECT (window_main, image180, "image180");
...
create_window_buttons (void)
{
  ...
  GtkWidget *clist_horiz;
  GtkWidget *label58;
  GtkWidget *label59;
  GtkWidget *table7;
  GtkWidget *entry_hlabel;
  GtkWidget *entry_hcmd;
  GtkWidget *label68;
  GtkWidget *label69;
  GtkWidget *hbuttonbox13;
  GtkWidget *button_hadd;
  GtkWidget *button_hdel;
  GtkWidget *label56;
  GtkWidget *frame19;
  GtkWidget *alignment5;
  GtkWidget *vbox27;
  GtkWidget *scrolledwindow9;
  GtkWidget *clist_vert;
  GtkWidget *label64;
  GtkWidget *label65;
  GtkWidget *table8;
  GtkWidget *entry_vlabel;
  GtkWidget *label66;
  GtkWidget *label67;
  GtkWidget *entry_vcmd;
  GtkWidget *hbuttonbox14;
  GtkWidget *button_vadd;
  GtkWidget *button_vdel;
  GtkWidget *label57;
  ...
  window_buttons = gtk_window_new (GTK_WINDOW_TOPLEVEL);
  gtk_widget_set_size_request (window_buttons, 640, 300);
  gtk_container_set_border_width (GTK_CONTAINER (window_buttons), 4);
  gtk_window_set_title (GTK_WINDOW (window_buttons), "Buttons");

  vbox25 = gtk_vbox_new (FALSE, 4);
  gtk_widget_show (vbox25);
  gtk_container_add (GTK_CONTAINER (window_buttons), vbox25);
  ...
  gtk_box_pack_start (GTK_BOX (hbox19), frame18, TRUE, TRUE, 0);
  gtk_container_set_border_width (GTK_CONTAINER (frame18), 8);

  alignment4 = gtk_alignment_new (0.5, 0.5, 1, 1);
  gtk_widget_show (alignment4);
  gtk_container_add (GTK_CONTAINER (frame18), alignment4);
  gtk_container_set_border_width (GTK_CONTAINER (alignment4), 4);

  vbox26 = gtk_vbox_new (FALSE, 0);
  gtk_widget_show (vbox26);
  gtk_container_add (GTK_CONTAINER (alignment4), vbox26);

  scrolledwindow8 = gtk_scrolled_window_new (NULL, NULL);
  gtk_widget_show (scrolledwindow8);
  gtk_box_pack_start (GTK_BOX (vbox26), scrolledwindow8, TRUE, TRUE, 0);
  ...
  clist_horiz = gtk_clist_new (2);
  gtk_widget_show (clist_horiz);
  gtk_container_add (GTK_CONTAINER (scrolledwindow8), clist_horiz);
  gtk_clist_set_column_width (GTK_CLIST (clist_horiz), 0, 80);
  gtk_clist_set_column_width (GTK_CLIST (clist_horiz), 1, 80);
  gtk_clist_column_titles_show (GTK_CLIST (clist_horiz));

  label58 = gtk_label_new ("Label");
  gtk_widget_show (label58);
  gtk_clist_set_column_widget (GTK_CLIST (clist_horiz), 0, label58);

  label59 = gtk_label_new ("Commands");
  gtk_widget_show (label59);
  gtk_clist_set_column_widget (GTK_CLIST (clist_horiz), 1, label59);

  table7 = gtk_table_new (2, 2, FALSE);
  gtk_widget_show (table7);
  gtk_box_pack_start (GTK_BOX (vbox26), table7, FALSE, FALSE, 0);

  entry_hlabel = gtk_entry_new ();
  gtk_widget_show (entry_hlabel);
  gtk_table_attach (GTK_TABLE (table7), entry_hlabel, 0, 1, 1, 2,
                    (GtkAttachOptions) (0),
                    (GtkAttachOptions) (0), 0, 0);
  gtk_entry_set_max_length (GTK_ENTRY (entry_hlabel), 19);
  gtk_entry_set_invisible_char (GTK_ENTRY (entry_hlabel), 9679);
  gtk_entry_set_width_chars (GTK_ENTRY (entry_hlabel), 10);

  entry_hcmd = gtk_entry_new ();
  gtk_widget_show (entry_hcmd);
  gtk_table_attach (GTK_TABLE (table7), entry_hcmd, 1, 2, 1, 2,
                    (GtkAttachOptions) (GTK_EXPAND | GTK_FILL),
                    (GtkAttachOptions) (0), 0, 0);
  gtk_entry_set_invisible_char (GTK_ENTRY (entry_hcmd), 9679);

  label68 = gtk_label_new ("<b>Label</b>");
  gtk_widget_show (label68);
  gtk_table_attach (GTK_TABLE (table7), label68, 0, 1, 0, 1,
                    (GtkAttachOptions) (GTK_FILL),
                    (GtkAttachOptions) (0), 0, 0);
  gtk_label_set_use_markup (GTK_LABEL (label68), TRUE);
  gtk_misc_set_alignment (GTK_MISC (label68), 0, 0.5);

  label69 = gtk_label_new ("<b>Commands</b>");
  gtk_widget_show (label69);
  gtk_table_attach (GTK_TABLE (table7), label69, 1, 2, 0, 1,
                    (GtkAttachOptions) (GTK_FILL),
                    (GtkAttachOptions) (0), 0, 0);
  ...
  gtk_box_pack_start (GTK_BOX (vbox26), hbuttonbox13, FALSE, TRUE, 0);
  gtk_container_set_border_width (GTK_CONTAINER (hbuttonbox13), 4);
  gtk_button_box_set_layout (GTK_BUTTON_BOX (hbuttonbox13), GTK_BUTTONBOX_SPREAD);

  button_hadd = gtk_button_new_from_stock ("gtk-add");
  gtk_widget_show (button_hadd);
  gtk_container_add (GTK_CONTAINER (hbuttonbox13), button_hadd);
  GTK_WIDGET_SET_FLAGS (button_hadd, GTK_CAN_DEFAULT);
  gtk_tooltips_set_tip (tooltips, button_hadd, "Add a button to the horizontal button list.", NULL);

  button_hdel = gtk_button_new_from_stock ("gtk-remove");
  gtk_widget_show (button_hdel);
  gtk_container_add (GTK_CONTAINER (hbuttonbox13), button_hdel);
  GTK_WIDGET_SET_FLAGS (button_hdel, GTK_CAN_DEFAULT);
  gtk_tooltips_set_tip (tooltips, button_hdel, "Remove a button from the horizontal button list.", NULL);

  label56 = gtk_label_new ("<big><b>Horizontal buttons</b></big>");
  gtk_widget_show (label56);
  gtk_frame_set_label_widget (GTK_FRAME (frame18), label56);
  gtk_label_set_use_markup (GTK_LABEL (label56), TRUE);

  frame19 = gtk_frame_new (NULL);
  gtk_widget_show (frame19);
  gtk_box_pack_start (GTK_BOX (hbox19), frame19, TRUE, TRUE, 0);
  gtk_container_set_border_width (GTK_CONTAINER (frame19), 8);

  alignment5 = gtk_alignment_new (0.5, 0.5, 1, 1);
  gtk_widget_show (alignment5);
  gtk_container_add (GTK_CONTAINER (frame19), alignment5);
  gtk_container_set_border_width (GTK_CONTAINER (alignment5), 4);

  vbox27 = gtk_vbox_new (FALSE, 0);
  gtk_widget_show (vbox27);
  gtk_container_add (GTK_CONTAINER (alignment5), vbox27);

  scrolledwindow9 = gtk_scrolled_window_new (NULL, NULL);
  gtk_widget_show (scrolledwindow9);
  gtk_box_pack_start (GTK_BOX (vbox27), scrolledwindow9, TRUE, TRUE, 0);
  ...
  clist_vert = gtk_clist_new (2);
  gtk_widget_show (clist_vert);
  gtk_container_add (GTK_CONTAINER (scrolledwindow9), clist_vert);
  gtk_clist_set_column_width (GTK_CLIST (clist_vert), 0, 80);
  gtk_clist_set_column_width (GTK_CLIST (clist_vert), 1, 80);
  gtk_clist_column_titles_show (GTK_CLIST (clist_vert));

  label64 = gtk_label_new ("Label");
  gtk_widget_show (label64);
  gtk_clist_set_column_widget (GTK_CLIST (clist_vert), 0, label64);

  label65 = gtk_label_new ("Commands");
  gtk_widget_show (label65);
  gtk_clist_set_column_widget (GTK_CLIST (clist_vert), 1, label65);

  table8 = gtk_table_new (2, 2, FALSE);
  gtk_widget_show (table8);
  gtk_box_pack_start (GTK_BOX (vbox27), table8, FALSE, FALSE, 0);

  entry_vlabel = gtk_entry_new ();
  gtk_widget_show (entry_vlabel);
  gtk_table_attach (GTK_TABLE (table8), entry_vlabel, 0, 1, 1, 2,
                    (GtkAttachOptions) (0),
                    (GtkAttachOptions) (0), 0, 0);
  gtk_entry_set_max_length (GTK_ENTRY (entry_vlabel), 19);
  gtk_entry_set_invisible_char (GTK_ENTRY (entry_vlabel), 9679);
  gtk_entry_set_width_chars (GTK_ENTRY (entry_vlabel), 10);

  label66 = gtk_label_new ("<b>Label</b>");
  gtk_widget_show (label66);
  gtk_table_attach (GTK_TABLE (table8), label66, 0, 1, 0, 1,
                    (GtkAttachOptions) (GTK_FILL),
                    (GtkAttachOptions) (0), 0, 0);
  gtk_label_set_use_markup (GTK_LABEL (label66), TRUE);
  gtk_misc_set_alignment (GTK_MISC (label66), 0, 0.5);

  label67 = gtk_label_new ("<b>Commands</b>");
  gtk_widget_show (label67);
  gtk_table_attach (GTK_TABLE (table8), label67, 1, 2, 0, 1,
                    (GtkAttachOptions) (GTK_FILL),
                    (GtkAttachOptions) (0), 0, 0);
  gtk_label_set_use_markup (GTK_LABEL (label67), TRUE);
  gtk_misc_set_alignment (GTK_MISC (label67), 0, 0.5);

  entry_vcmd = gtk_entry_new ();
  gtk_widget_show (entry_vcmd);
  gtk_table_attach (GTK_TABLE (table8), entry_vcmd, 1, 2, 1, 2,
                    (GtkAttachOptions) (GTK_EXPAND | GTK_FILL),
                    (GtkAttachOptions) (0), 0, 0);
  gtk_entry_set_invisible_char (GTK_ENTRY (entry_vcmd), 9679);

  hbuttonbox14 = gtk_hbutton_box_new ();
  gtk_widget_show (hbuttonbox14);
  gtk_box_pack_start (GTK_BOX (vbox27), hbuttonbox14, FALSE, TRUE, 0);
  gtk_container_set_border_width (GTK_CONTAINER (hbuttonbox14), 4);
  gtk_button_box_set_layout (GTK_BUTTON_BOX (hbuttonbox14), GTK_BUTTONBOX_SPREAD);

  button_vadd = gtk_button_new_from_stock ("gtk-add");
  gtk_widget_show (button_vadd);
  gtk_container_add (GTK_CONTAINER (hbuttonbox14), button_vadd);
  GTK_WIDGET_SET_FLAGS (button_vadd, GTK_CAN_DEFAULT);
  gtk_tooltips_set_tip (tooltips, button_vadd, "Add a button to the vertical button list.", NULL);

  button_vdel = gtk_button_new_from_stock ("gtk-remove");
  gtk_widget_show (button_vdel);
  gtk_container_add (GTK_CONTAINER (hbuttonbox14), button_vdel);
  GTK_WIDGET_SET_FLAGS (button_vdel, GTK_CAN_DEFAULT);
  gtk_tooltips_set_tip (tooltips, button_vdel, "Remove a button from the vertical button list.", NULL);

  label57 = gtk_label_new ("<big><b>Vertical buttons</b></big>");
  gtk_widget_show (label57);
  gtk_frame_set_label_widget (GTK_FRAME (frame19), label57);
  gtk_label_set_use_markup (GTK_LABEL (label57), TRUE);

  hseparator11 = gtk_hseparator_new ();
  gtk_widget_show (hseparator11);
  gtk_box_pack_start (GTK_BOX (vbox25), hseparator11, FALSE, FALSE, 0);
  ...
  button43 = gtk_button_new_from_stock ("gtk-save");
  gtk_widget_show (button43);
  gtk_container_add (GTK_CONTAINER (hbuttonbox12), button43);
  GTK_WIDGET_SET_FLAGS (button43, GTK_CAN_DEFAULT);
  gtk_tooltips_set_tip (tooltips, button43, "Save the defined buttons to disk", NULL);

  button44 = gtk_button_new_from_stock ("gtk-close");
  gtk_widget_show (button44);
  gtk_container_add (GTK_CONTAINER (hbuttonbox12), button44);
  GTK_WIDGET_SET_FLAGS (button44, GTK_CAN_DEFAULT);
  gtk_tooltips_set_tip (tooltips, button44, "Close this window", NULL);

  g_signal_connect ((gpointer) window_buttons, "destroy_event",
                    G_CALLBACK (close_window),
                    NULL);
  g_signal_connect ((gpointer) clist_horiz, "select_row",
                    G_CALLBACK (on_clist_button_select_row),
                    NULL);
  g_signal_connect_swapped ((gpointer) button_hadd, "clicked",
                            G_CALLBACK (on_button_buttadd_clicked),
                            GTK_OBJECT (clist_horiz));
  g_signal_connect_swapped ((gpointer) button_hdel, "clicked",
                            G_CALLBACK (on_button_buttdel_clicked),
                            GTK_OBJECT (clist_horiz));
  g_signal_connect ((gpointer) clist_vert, "select_row",
                    G_CALLBACK (on_clist_button_select_row),
                    NULL);
  g_signal_connect_swapped ((gpointer) button_vadd, "clicked",
                            G_CALLBACK (on_button_buttadd_clicked),
                            GTK_OBJECT (clist_vert));
  g_signal_connect_swapped ((gpointer) button_vdel, "clicked",
                            G_CALLBACK (on_button_buttdel_clicked),
                            GTK_OBJECT (clist_vert));
  g_signal_connect ((gpointer) button43, "clicked",
                    G_CALLBACK (save_buttons),
                    NULL);
  ...
  /* Store pointers to all widgets, for use by lookup_widget(). */
  GLADE_HOOKUP_OBJECT_NO_REF (window_buttons, window_buttons, "window_buttons");
  GLADE_HOOKUP_OBJECT (window_buttons, vbox25, "vbox25");
  GLADE_HOOKUP_OBJECT (window_buttons, hbox19, "hbox19");
  GLADE_HOOKUP_OBJECT (window_buttons, frame18, "frame18");
  GLADE_HOOKUP_OBJECT (window_buttons, alignment4, "alignment4");
  GLADE_HOOKUP_OBJECT (window_buttons, vbox26, "vbox26");
  GLADE_HOOKUP_OBJECT (window_buttons, scrolledwindow8, "scrolledwindow8");
  GLADE_HOOKUP_OBJECT (window_buttons, clist_horiz, "clist_horiz");
  GLADE_HOOKUP_OBJECT (window_buttons, label58, "label58");
  GLADE_HOOKUP_OBJECT (window_buttons, label59, "label59");
  GLADE_HOOKUP_OBJECT (window_buttons, table7, "table7");
  GLADE_HOOKUP_OBJECT (window_buttons, entry_hlabel, "entry_hlabel");
  GLADE_HOOKUP_OBJECT (window_buttons, entry_hcmd, "entry_hcmd");
  GLADE_HOOKUP_OBJECT (window_buttons, label68, "label68");
  GLADE_HOOKUP_OBJECT (window_buttons, label69, "label69");
  GLADE_HOOKUP_OBJECT (window_buttons, hbuttonbox13, "hbuttonbox13");
  GLADE_HOOKUP_OBJECT (window_buttons, button_hadd, "button_hadd");
  GLADE_HOOKUP_OBJECT (window_buttons, button_hdel, "button_hdel");
  GLADE_HOOKUP_OBJECT (window_buttons, label56, "label56");
  GLADE_HOOKUP_OBJECT (window_buttons, frame19, "frame19");
  GLADE_HOOKUP_OBJECT (window_buttons, alignment5, "alignment5");
  GLADE_HOOKUP_OBJECT (window_buttons, vbox27, "vbox27");
  GLADE_HOOKUP_OBJECT (window_buttons, scrolledwindow9, "scrolledwindow9");
  GLADE_HOOKUP_OBJECT (window_buttons, clist_vert, "clist_vert");
  GLADE_HOOKUP_OBJECT (window_buttons, label64, "label64");
  GLADE_HOOKUP_OBJECT (window_buttons, label65, "label65");
  GLADE_HOOKUP_OBJECT (window_buttons, table8, "table8");
  GLADE_HOOKUP_OBJECT (window_buttons, entry_vlabel, "entry_vlabel");
  GLADE_HOOKUP_OBJECT (window_buttons, label66, "label66");
  GLADE_HOOKUP_OBJECT (window_buttons, label67, "label67");
  GLADE_HOOKUP_OBJECT (window_buttons, entry_vcmd, "entry_vcmd");
  GLADE_HOOKUP_OBJECT (window_buttons, hbuttonbox14, "hbuttonbox14");
  GLADE_HOOKUP_OBJECT (window_buttons, button_vadd, "button_vadd");
  GLADE_HOOKUP_OBJECT (window_buttons, button_vdel, "button_vdel");
  GLADE_HOOKUP_OBJECT (window_buttons, label57, "label57");
  GLADE_HOOKUP_OBJECT (window_buttons, hseparator11, "hseparator11");
  GLADE_HOOKUP_OBJECT (window_buttons, hbuttonbox12, "hbuttonbox12");
  GLADE_HOOKUP_OBJECT (window_buttons, button43, "button43");
  GLADE_HOOKUP_OBJECT (window_buttons, button44, "button44");
  GLADE_HOOKUP_OBJECT_NO_REF (window_buttons, tooltips, "tooltips");
...
GtkWidget*
create_window_msp (void)
{
  GtkWidget *window_msp;
  GtkWidget *vbox31;
  GtkWidget *vbox32;
  GtkWidget *checkbutton_inline;
  GtkWidget *checkbutton_download;
  GtkWidget *frame26;
  ...
  window_msp = gtk_window_new (GTK_WINDOW_TOPLEVEL);
  gtk_container_set_border_width (GTK_CONTAINER (window_msp), 8);
  gtk_window_set_title (GTK_WINDOW (window_msp), "MSP protocol settings");
  gtk_window_set_position (GTK_WINDOW (window_msp), GTK_WIN_POS_MOUSE);
  gtk_window_set_modal (GTK_WINDOW (window_msp), TRUE);

  vbox31 = gtk_vbox_new (FALSE, 0);
  gtk_widget_show (vbox31);
  gtk_container_add (GTK_CONTAINER (window_msp), vbox31);
  ...
  checkbutton_download = gtk_check_button_new_with_mnemonic ("Allow download");
  gtk_widget_show (checkbutton_download);
  gtk_box_pack_start (GTK_BOX (vbox32), checkbutton_download, FALSE, FALSE, 0);
  gtk_tooltips_set_tip (tooltips, checkbutton_download, "Allow GGMud to download missing sounds from remote if not available locally", NULL);
  ...
  gtk_entry_set_max_length (GTK_ENTRY (entry_sound_path), 255);
  ...
  gtk_entry_set_max_length (GTK_ENTRY (entry_sound_player), 127);
  ...
  gtk_entry_set_max_length (GTK_ENTRY (entry_music_path), 255);
  ...
  gtk_entry_set_max_length (GTK_ENTRY (entry_music_player), 127);
  ...
  g_signal_connect ((gpointer) window_msp, "delete_event",
                    G_CALLBACK (on_msp_ko_clicked),
                    NULL);
  g_signal_connect ((gpointer) button52, "clicked",
                    G_CALLBACK (on_msp_ok_clicked),
                    NULL);
  ...
  /* Store pointers to all widgets, for use by lookup_widget(). */
  GLADE_HOOKUP_OBJECT_NO_REF (window_msp, window_msp, "window_msp");
  GLADE_HOOKUP_OBJECT (window_msp, vbox31, "vbox31");
  GLADE_HOOKUP_OBJECT (window_msp, vbox32, "vbox32");
  GLADE_HOOKUP_OBJECT (window_msp, checkbutton_inline, "checkbutton_inline");
  GLADE_HOOKUP_OBJECT (window_msp, checkbutton_download, "checkbutton_download");
  GLADE_HOOKUP_OBJECT (window_msp, frame26, "frame26");
  GLADE_HOOKUP_OBJECT (window_msp, alignment8, "alignment8");
  GLADE_HOOKUP_OBJECT (window_msp, table12, "table12");
  GLADE_HOOKUP_OBJECT (window_msp, button54, "button54");
  GLADE_HOOKUP_OBJECT (window_msp, image87, "image87");
  GLADE_HOOKUP_OBJECT (window_msp, button55, "button55");
  GLADE_HOOKUP_OBJECT (window_msp, image88, "image88");
  GLADE_HOOKUP_OBJECT (window_msp, label88, "label88");
  GLADE_HOOKUP_OBJECT (window_msp, entry_sound_path, "entry_sound_path");
  GLADE_HOOKUP_OBJECT (window_msp, entry_sound_player, "entry_sound_player");
  GLADE_HOOKUP_OBJECT (window_msp, label87, "label87");
  GLADE_HOOKUP_OBJECT (window_msp, label85, "label85");
  GLADE_HOOKUP_OBJECT (window_msp, frame27, "frame27");
  GLADE_HOOKUP_OBJECT (window_msp, alignment9, "alignment9");
  GLADE_HOOKUP_OBJECT (window_msp, table13, "table13");
  GLADE_HOOKUP_OBJECT (window_msp, button56, "button56");
  GLADE_HOOKUP_OBJECT (window_msp, image89, "image89");
  GLADE_HOOKUP_OBJECT (window_msp, button57, "button57");
  GLADE_HOOKUP_OBJECT (window_msp, image90, "image90");
  GLADE_HOOKUP_OBJECT (window_msp, label89, "label89");
  GLADE_HOOKUP_OBJECT (window_msp, label90, "label90");
  GLADE_HOOKUP_OBJECT (window_msp, entry_music_path, "entry_music_path");
  GLADE_HOOKUP_OBJECT (window_msp, entry_music_player, "entry_music_player");
  GLADE_HOOKUP_OBJECT (window_msp, label86, "label86");
  GLADE_HOOKUP_OBJECT (window_msp, hseparator13, "hseparator13");
  GLADE_HOOKUP_OBJECT (window_msp, hbuttonbox16, "hbuttonbox16");
  GLADE_HOOKUP_OBJECT (window_msp, button52, "button52");
  GLADE_HOOKUP_OBJECT (window_msp, button53, "button53");
  GLADE_HOOKUP_OBJECT_NO_REF (window_msp, tooltips, "tooltips");

  return window_msp;
}

GtkWidget*
create_window_sub (void)
{
  ...
  gtk_widget_set_size_request (window_sub, 480, 320);
  gtk_container_set_border_width (GTK_CONTAINER (window_sub), 4);
  gtk_window_set_title (GTK_WINDOW (window_sub), "Substitutions");

  vbox33 = gtk_vbox_new (FALSE, 5);
  gtk_widget_show (vbox33);
  gtk_container_add (GTK_CONTAINER (window_sub), vbox33);

  scrolledwindow10 = gtk_scrolled_window_new (NULL, NULL);
  gtk_widget_show (scrolledwindow10);
  gtk_box_pack_start (GTK_BOX (vbox33), scrolledwindow10, TRUE, TRUE, 0);
  ...
  label91 = gtk_label_new ("<b>Original</b>");
  gtk_widget_show (label91);
  gtk_clist_set_column_widget (GTK_CLIST (clist_sub), 0, label91);
  gtk_label_set_use_markup (GTK_LABEL (label91), TRUE);

  label92 = gtk_label_new ("<b>Replacement</b>");
  ...
  gtk_box_pack_start (GTK_BOX (vbox33), table14, FALSE, FALSE, 0);
  ...
  gtk_table_attach (GTK_TABLE (table14), button58, 0, 1, 1, 2,
                    (GtkAttachOptions) (GTK_FILL),
                    (GtkAttachOptions) (0), 0, 0);
  gtk_tooltips_set_tip (tooltips, button58, "Find a specific word in substitution original or replacement.", NULL);

  image91 = gtk_image_new_from_stock ("gtk-find", GTK_ICON_SIZE_BUTTON);
  gtk_widget_show (image91);
  gtk_container_add (GTK_CONTAINER (button58), image91);

  label93 = gtk_label_new ("<b>Original</b>");
  gtk_widget_show (label93);
  gtk_table_attach (GTK_TABLE (table14), label93, 1, 2, 0, 1,
                    (GtkAttachOptions) (GTK_FILL),
                    (GtkAttachOptions) (0), 0, 0);
  gtk_label_set_use_markup (GTK_LABEL (label93), TRUE);

  label94 = gtk_label_new ("<b>Replacement</b>");
  gtk_widget_show (label94);
  gtk_table_attach (GTK_TABLE (table14), label94, 2, 3, 0, 1,
                    (GtkAttachOptions) (GTK_FILL),
                    (GtkAttachOptions) (0), 0, 0);
  gtk_label_set_use_markup (GTK_LABEL (label94), TRUE);

  entry_replacement = gtk_entry_new ();
  gtk_widget_show (entry_replacement);
  gtk_table_attach (GTK_TABLE (table14), entry_replacement, 2, 3, 1, 2,
                    (GtkAttachOptions) (GTK_EXPAND | GTK_FILL),
                    (GtkAttachOptions) (0), 0, 0);
  gtk_entry_set_max_length (GTK_ENTRY (entry_replacement), 1000);
  gtk_entry_set_invisible_char (GTK_ENTRY (entry_replacement), 9679);

  entry_orig = gtk_entry_new ();
  gtk_widget_show (entry_orig);
  gtk_table_attach (GTK_TABLE (table14), entry_orig, 1, 2, 1, 2,
                    (GtkAttachOptions) (0),
                    (GtkAttachOptions) (0), 0, 0);
  gtk_entry_set_max_length (GTK_ENTRY (entry_orig), 100);
  gtk_entry_set_invisible_char (GTK_ENTRY (entry_orig), 9679);

  hseparator14 = gtk_hseparator_new ();
  gtk_widget_show (hseparator14);
  gtk_box_pack_start (GTK_BOX (vbox33), hseparator14, FALSE, FALSE, 0);

  hbuttonbox17 = gtk_hbutton_box_new ();
  gtk_widget_show (hbuttonbox17);
  gtk_box_pack_start (GTK_BOX (vbox33), hbuttonbox17, FALSE, FALSE, 0);

  button59 = gtk_button_new_from_stock ("gtk-add");
  gtk_widget_show (button59);
  gtk_container_add (GTK_CONTAINER (hbuttonbox17), button59);
  GTK_WIDGET_SET_FLAGS (button59, GTK_CAN_DEFAULT);
  gtk_tooltips_set_tip (tooltips, button59, "Add a new ALIAS or replace an existing one (only if the alias label already exists)", NULL);

  button60 = gtk_button_new_from_stock ("gtk-delete");
  gtk_widget_show (button60);
  gtk_container_add (GTK_CONTAINER (hbuttonbox17), button60);
  GTK_WIDGET_SET_FLAGS (button60, GTK_CAN_DEFAULT);
  gtk_tooltips_set_tip (tooltips, button60, "Delete the selected ALIAS.", NULL);

  button61 = gtk_button_new_from_stock ("gtk-save");
  gtk_widget_show (button61);
  gtk_container_add (GTK_CONTAINER (hbuttonbox17), button61);
  GTK_WIDGET_SET_FLAGS (button61, GTK_CAN_DEFAULT);
  gtk_tooltips_set_tip (tooltips, button61, "Save your aliases to disk.", NULL);

  button62 = gtk_button_new_from_stock ("gtk-close");
  gtk_widget_show (button62);
  gtk_container_add (GTK_CONTAINER (hbuttonbox17), button62);
  GTK_WIDGET_SET_FLAGS (button62, GTK_CAN_DEFAULT);
  gtk_tooltips_set_tip (tooltips, button62, "Close the aliases window.", NULL);

  g_signal_connect ((gpointer) window_sub, "destroy_event",
                    G_CALLBACK (close_window),
                    NULL);
  g_signal_connect ((gpointer) clist_sub, "select_row",
                    G_CALLBACK (sub_selection_made),
                    NULL);
  g_signal_connect_swapped ((gpointer) button58, "clicked",
                            G_CALLBACK (find_in_list),
                            GTK_OBJECT (clist_sub));
  g_signal_connect_swapped ((gpointer) button59, "clicked",
                            G_CALLBACK (sub_button_add),
                            GTK_OBJECT (clist_sub));
  g_signal_connect_swapped ((gpointer) button60, "clicked",
                            G_CALLBACK (sub_button_delete),
                            GTK_OBJECT (clist_sub));
  g_signal_connect_swapped ((gpointer) button61, "clicked",
                            G_CALLBACK (save_subs),
                            GTK_OBJECT (clist_sub));
  ...
  /* Store pointers to all widgets, for use by lookup_widget(). */
  GLADE_HOOKUP_OBJECT_NO_REF (window_sub, window_sub, "window_sub");
  GLADE_HOOKUP_OBJECT (window_sub, vbox33, "vbox33");
  GLADE_HOOKUP_OBJECT (window_sub, scrolledwindow10, "scrolledwindow10");
  ...
  GLADE_HOOKUP_OBJECT (window_sub, label93, "label93");
  GLADE_HOOKUP_OBJECT (window_sub, label94, "label94");
  GLADE_HOOKUP_OBJECT (window_sub, entry_replacement, "entry_replacement");
  GLADE_HOOKUP_OBJECT (window_sub, entry_orig, "entry_orig");
  GLADE_HOOKUP_OBJECT (window_sub, hseparator14, "hseparator14");
  GLADE_HOOKUP_OBJECT (window_sub, hbuttonbox17, "hbuttonbox17");
  GLADE_HOOKUP_OBJECT (window_sub, button59, "button59");
  GLADE_HOOKUP_OBJECT (window_sub, button60, "button60");
  GLADE_HOOKUP_OBJECT (window_sub, button61, "button61");
  GLADE_HOOKUP_OBJECT (window_sub, button62, "button62");
  GLADE_HOOKUP_OBJECT_NO_REF (window_sub, tooltips, "tooltips");
